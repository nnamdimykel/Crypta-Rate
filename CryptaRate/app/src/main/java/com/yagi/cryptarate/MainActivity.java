...
import static com.yagi.cryptarate.Constant.ORDER_ALPHABETICAL;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderMode = settings.getInt("orderMode", Constant.ORDER_ALPHABETICAL);
    ...
    private class MyAdapter extends BaseAdapter {
        ArrayList<RatesLedger.MoneyRate> rates;

        private MyAdapter(ArrayList<RatesLedger.MoneyRate> ratesInstance) {
            rates = ratesInstance;
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final RatesLedger.MoneyRate rateRow = rates.get(position);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(Constant.EXTRA_CURRENCY, crossCurrency);
                    intent.putExtra(Constant.EXTRA_BTC_RATE, crossBtc);
                    intent.putExtra(Constant.EXTRA_ETH_RATE, crossEth);
    ...
    public void downloadRates() {
        ...
        JsonObjectRequest requestNameAvatar = new JsonObjectRequest(Request.Method.GET, requestUrl, null,
            ...
            public void onErrorResponse(VolleyError error) {
                Snackbar.make(mainView, Constant.REFRESH_ERROR, Snackbar.LENGTH_LONG).setAction("Action", null).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            if(orderMode == ORDER_ALPHABETICAL) orderMode = Constant.ORDER_BY_RATE;
            else orderMode = ORDER_ALPHABETICAL;
            ratesLedger.orderList(orderMode);
            ratesListView.setAdapter(new MyAdapter(ratesLedger.ratesArrayList));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_github) {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/nnamdimykel"));
